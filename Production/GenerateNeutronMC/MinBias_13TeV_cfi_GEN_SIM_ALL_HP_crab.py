...
# with command line options: MinBias_13TeV_cfi -s GEN,SIM,DIGI,L1,DIGI2RAW,RAW2DIGI,L1Reco,RECO --customise SimG4Core/Application/NeutronBGforMuonsHP_cff.customise --pileup=NoPileUp --geometry DB --conditions auto:run2_mc --eventcontent=FEVTDEBUG --datatier GEN-SIM --dirout=./ -n 50 --fileout file:mb_13TeV_mu_ALL_hp_test.root --beamspot Realistic50ns13TeVCollision --mc --python_filename=MinBias_13TeV_cfi_GEN_SIM_ALL_HP.py --no_exec --geometry Extended2015,Extended2015Reco --magField 38T_PostLS1
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('mb_13TeV_mu_ALL_hp_test.root'),
...
# Turn on thermal neutron option
