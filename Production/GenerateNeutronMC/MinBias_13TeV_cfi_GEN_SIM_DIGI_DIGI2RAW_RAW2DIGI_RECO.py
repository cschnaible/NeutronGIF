...
# with command line options: MinBias_13TeV_cfi -s GEN,SIM,DIGI,DIGI2RAW,RAW2DIGI,RECO --customise SimG4Core/Application/NeutronBGforMuonsXS_cff.customise --pileup=NoPileUp --geometry DB --conditions auto:run2_mc --eventcontent=FEVTDEBUG --datatier GEN-SIM --dirout=./ -n 50 --fileout file:mb_13TeV_mu_xs_gen_sim_digi_digi2raw_raw2digi_reco.root --beamspot Realistic50ns13TeVCollision --mc --python_filename=MinBias_13TeV_cfi_GEN_SIM_DIGI_DIGI2RAW_RAW2DIGI_RECO.py --no_exec --geometry Extended2015,Extended2015Reco --magField 38T_PostLS1
...
process.FEVTDEBUGoutput = cms.OutputModule("PoolOutputModule",
    ...
    #fileName = cms.untracked.string('mb_13TeV_mu_xs_gen_sim_digi_digi2raw_raw2digi_reco.root'),
    fileName = cms.untracked.string('./file:mb_13TeV_mu_xs_gen_sim_digi_digi2raw_raw2digi_reco.root'),
